...
public class AuthManager {
     ...
     * @throws SQLException 
     */
//    public static String getPassword(String username) throws UserNotFoundException, SQLException {
//    	String strPassword = "";
//    	ApnUserPO apnUserPO = ServiceLocator.getUserService().gainUserByUsername(username);
//    	if(null != apnUserPO && null != apnUserPO.getPassword() && !"".equals(apnUserPO.getPassword())){
//    		strPassword = apnUserPO.getPassword();
//    	}
//        return strPassword;
//    }
     ...
     * @throws SQLException 
     */
    public static AuthToken authenticate(String username, String password) throws UnauthenticatedException, SQLException {
    ...
    public static AuthToken authenticate(String username, String token,
            String digest) throws UnauthenticatedException, SQLException {
